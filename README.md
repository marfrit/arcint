...
recorded above), **0.4.1 took the GGUF path to 68 % / 98 % of the operator's prefill bars and, in its native form, to the decode bar** (`docs/milestone-0.4.1.md`; 0.4.2 the repacked set's gemm, 0.4.3 the tiled kernel's next 30 %, 0.4.4 the Q5_K decode rate) and **0.5.0 serves Qwen Flash Next**
